...
//boucle pour parcourir la liste
    cheking(grille, 3, 3, largeur, cible, tabSolutions, taille,59);

}

void
cheking(int grille[10][10], int y, int x, int position, int largeur, solution *tabSolutions, int *taille, int cible) {
